...
#define CPU_MILLIVOLTS {\
	750, 762, 775, 800, 812, 825, 850, 862, 875, 887, 900, 912, 916, 925, 937, 950, 962, 975, 1000, 1012, 1037, 1050, 1062, 1087, 1100, 1125, 1137, 1162, 1175, 1200, 1212, 1237, 1262, 1275, 1287, 1300, 1325, 1350};
...
static struct dvfs cpu_dvfs_table[] = {
	...
	CPU_DVFS("cpu_g",  2, 2, MHZ,   1,   1,   1,   480, 480, 480, 650, 650, 650, 650,  780,  780,  780,  780,  780,  780,  780,  990,  990, 1040, 1040, 1040, 1100, 1100, 1200, 1200, 1300, 1300, 1470, 1470, 1500, 1500, 1570, 1570, 1600, 1600, 1700, 1800),
	CPU_DVFS("cpu_g",  2, 3, MHZ,   1,   1,   1,   520, 520, 520, 700, 700, 700, 700,  860,  860,  860,  860,  860,  860,  860, 1050, 1050, 1150, 1150, 1150, 1200, 1200, 1300, 1370, 1400, 1400, 1470, 1470, 1500, 1500, 1600, 1600, 1700, 1800),

	CPU_DVFS("cpu_g",  3, 1, MHZ,   1,   1,   1,   460, 460, 460, 550, 550, 550, 550,  680,  680,  680,  680,  680,  680,  820,  820,  970,  970,  970, 1040, 1040, 1080, 1080, 1150, 1150, 1200, 1200, 1280, 1280, 1300, 1400, 1400, 1500, 1500, 1600, 1600, 1700, 1800),
	CPU_DVFS("cpu_g",  3, 2, MHZ,   1,   1,   1,   480, 480, 480, 650, 650, 650, 650,  780,  780,  780,  780,  780,  780,  780,  990,  990, 1040, 1040, 1040, 1100, 1100, 1200, 1200, 1300, 1300, 1470, 1470, 1500, 1500, 1570, 1570, 1600, 1600, 1700, 1800),
	CPU_DVFS("cpu_g",  3, 3, MHZ,   1,   1,   1,   520, 520, 520, 700, 700, 700, 700,  860,  860,  860,  860,  860,  860,  860, 1050, 1050, 1150, 1150, 1150, 1200, 1200, 1300, 1370, 1400, 1400, 1470, 1470, 1500, 1500, 1600, 1600, 1700, 1800),
	...
	CPU_DVFS("cpu_g",  5, 0, MHZ,   1,   1,   1,   460, 460, 460, 550, 550, 550, 550,  680,  680,  680,  680,  680,  680,  820,  820,  970,  970,  970, 1040, 1040, 1080, 1080, 1150, 1150, 1200, 1200, 1280, 1280, 1300, 1400, 1400, 1500, 1500, 1600, 1600, 1700, 1800),
	CPU_DVFS("cpu_g",  5, 1, MHZ,   1,   1,   1,   480, 480, 480, 650, 650, 650, 650,  780,  780,  780,  780,  780,  780,  780,  990,  990, 1040, 1040, 1040, 1100, 1100, 1200, 1200, 1300, 1300, 1470, 1470, 1500, 1500, 1570, 1570, 1600, 1600, 1700, 1800),
	CPU_DVFS("cpu_g",  5, 2, MHZ,   1,   1,   1,   520, 520, 520, 700, 700, 700, 700,  860,  860,  860,  860,  860,  860,  860, 1050, 1050, 1150, 1150, 1150, 1200, 1200, 1300, 1370, 1400, 1400, 1470, 1470, 1500, 1500, 1600, 1600, 1700, 1800),
#endif
	...
	CPU_DVFS("cpu_g",  5, 2, MHZ,   1,   1,   1,   520, 520, 520, 700, 700, 700, 700,  860,  860,  860,  860,  860,  860,  860, 1050, 1050, 1150, 1150, 1150, 1200, 1200, 1300, 1370, 1400, 1400, 1470, 1470, 1500, 1500, 1600, 1600, 1700, 1800),
#endif
#ifdef CONFIG_ME301T_OC
 	CPU_DVFS("cpu_g",  5, 0, MHZ,   460, 460, 460, 550, 550, 550, 550,  680,  680,  680,  680,  680,  680,  820,  820,  970,  970,  970, 1040, 1040, 1080, 1080, 1150, 1150, 1200, 1200, 1280, 1280, 1300, 1400, 1400, 1500, 1500, 1600, 1600, 1700),

 	CPU_DVFS("cpu_g",  5, 1, MHZ,   480, 480, 480, 650, 650, 650, 650,  780,  780,  780,  780,  780,  780,  780,  990,  990, 1040, 1040, 1040, 1100, 1100, 1200, 1200, 1300, 1300, 1470, 1470, 1500, 1500, 1570, 1570, 1600, 1600, 1700),

 	CPU_DVFS("cpu_g",  5, 2, MHZ,   520, 520, 520, 700, 700, 700, 700,  860,  860,  860,  860,  860,  860,  860, 1050, 1050, 1150, 1150, 1150, 1200, 1200, 1300, 1370, 1400, 1400, 1470, 1470, 1500, 1500, 1600, 1600, 1700),
#endif

	CPU_DVFS("cpu_g",  5, 3, MHZ,   1,   1,   1,   550, 550, 550, 770, 770, 770, 770,  940,  940,  940,  940,  940,  940,  940, 1160, 1160, 1300, 1300, 1370, 1370, 1400, 1400, 1470, 1470, 1500, 1500, 1570, 1570, 1600, 1700, 1800),
...
static struct dvfs cpu_0_dvfs_table[] = {
	...
	CPU_DVFS("cpu_0",  5, 3, MHZ, 475, 475, 620, 620, 620, 760, 760, 760, 910,  910,  910, 1000, 1000, 1000, 1000, 1000, 1000, 1150, 1150, 1150, 1150, 1150, 1300, 1300, 1300, 1300, 1400, 1400, 1400, 1400, 1500, 1500, 1500, 1500, 1500, 1600, 1600, 1600, 1600, 1700, 1800),
	CPU_DVFS("cpu_0",  5, 4, MHZ, 475, 620, 620, 620, 760, 760, 760, 910, 910, 1000, 1000, 1000, 1000, 1000, 1150, 1150, 1150, 1150, 1150, 1300, 1300, 1300, 1300, 1400, 1400, 1400, 1500, 1500, 1500, 1500, 1600, 1600, 1600, 1600, 1600, 1600, 1600, 1600, 1700, 1800),
	...
	CPU_DVFS("cpu_0", 12, 3, MHZ, 475, 475, 620, 620, 620, 760, 760, 760, 910,  910,  910, 1000, 1000, 1000, 1000, 1000, 1000, 1150, 1150, 1150, 1150, 1150, 1300, 1300, 1300, 1300, 1400, 1400, 1400, 1400, 1500, 1500, 1500, 1500, 1500, 1600, 1600, 1600, 1600, 1700, 1800),
	CPU_DVFS("cpu_0", 12, 4, MHZ, 475, 620, 620, 620, 760, 760, 760, 910, 910, 1000, 1000, 1000, 1000, 1000, 1000, 1150, 1150, 1150, 1150, 1300, 1300, 1300, 1300, 1400, 1400, 1400, 1500, 1500, 1500, 1500, 1500, 1600, 1600, 1600, 1600, 1600, 1600, 1600, 1700, 1800),
};
